...
// DESKTOP VIEW NAVBAR
	$("#care-tab").on("click", function(){
    	...
    	$("#fit-guide-content").fadeTo(100, 0).hide();
    	$("#percentages-wrapper").fadeTo(100, 0).hide();
    	$("#materials-content").fadeTo(100, 0).hide();
    	setTimeout(function(){ 
	    	$("#care-content").show().fadeTo(200, 1);
    	}, 100);
	});
	...
	$("#fit-guide-tab").on("click", function(){
    	...
    	$("#care-content").fadeTo(100, 0).hide();
    	$("#percentages-wrapper").fadeTo(100, 0).hide();
    	$("#materials-content").fadeTo(100, 0).hide();
    	setTimeout(function(){
	    	$("#fit-guide-content").show().fadeTo(200, 1);
    	}, 100);
	});
	...
	$("#materials-tab").on("click", function(){
    	...
    	$("#fit-guide-content").fadeTo(100, 0).hide();
    	setTimeout(function(){
	    	$("#percentages-wrapper").show().fadeTo(200, 1);
	    	$("#materials-content").show().css('display', 'inline-block').fadeTo(200, 1);
    	}, 100);
	});
